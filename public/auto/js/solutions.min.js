...
SymbolabPad.prototype = {
    init: function () {
        ...
        $("#main-input").keyup(function (e) {
            ...
            if (e.keyCode == 13) {
                if ($("#main-input").mathquill("latex") !== "") {
                    if (localStorage.getItem("quillPad")) {
                        localStorage.setItem("quillPad", localStorage.getItem("quillPad") + " \\\\ & " + $("#main-input").mathquill("latex"));
                    } else {
                        localStorage.setItem("quillPad", $("#main-input").mathquill("latex"));
                    }
                    const options = {
                        htmlTags: true
                    }
                    const formulaBlock = document.querySelector('#block-formula')
                    const span = document.createElement("span");
                    span.innerText = `\\[\\begin{equation}\\begin{aligned}${localStorage.getItem("quillPad")}\\end{aligned}\\end{equation}\\]`
                    formulaBlock.innerHTML = "";
                    formulaBlock.append(span);
                    MathJax.typesetPromise([formulaBlock], formulaBlock.innerHTML);
